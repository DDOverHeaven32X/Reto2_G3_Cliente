...
/**
 * Intefraz que gestiona todos los métodos de logica de la entidad Usuario en el
 * lado cliente
 *
 * @author Diego
 */
public interface UsuarioInterfaz {
    ...
    /**
     * Método que compruba si un usario con el correo y contraseña dada existe o
     * no(XML)
     *
     * @param responseType
     * @param login
    ...
    /**
     * Método que busca un usuario por login(XML)
     *
     * @param responseType
     * @param login
     * @return
    ...
    /**
     * Método que busca un usuario por Login(JSON)
     *
     * @param responseType
     * @param login
     * @return
